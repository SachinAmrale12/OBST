...
//        self.addGestureRecognizer(panGesture)
        ...
        viewHeaderPopup.backgroundColor = UIColor(red: (232.0/255.0), green: 63.0/255.0, blue: 67.0/255.0, alpha: 1.0)
...
//MARK: - Show Popup
    func show(complete : ((Int)->())? , view: UIView,animationType: NSString,strMessage: String,btnArray: NSArray,strTitle: String = "")
    {
        ...
        for strBtnTitle in btnArray
        {
            ...
            btnOk.titleLabel?.font = UIFont(name: FontName.HelveticaNeueBold, size: 15)
